...
int main(int argc, char *argv[])
{
  ...
  36:	83 c3 04             	add    $0x4,%ebx
  		close(fd);
  39:	50                   	push   %eax
  3a:	e8 bb 02 00 00       	call   2fa <close>
	for(i = 1; i < argc; i++){
  3f:	83 c4 10             	add    $0x10,%esp
  42:	39 f7                	cmp    %esi,%edi
  44:	74 2a                	je     70 <main+0x70>
		fd = open(argv[i], O_CREATE);
  46:	83 ec 08             	sub    $0x8,%esp
  49:	68 00 02 00 00       	push   $0x200
  4e:	ff 33                	pushl  (%ebx)
  50:	e8 bd 02 00 00       	call   312 <open>
		if(fd < 0){
  55:	83 c4 10             	add    $0x10,%esp
  58:	85 c0                	test   %eax,%eax
  5a:	79 d4                	jns    30 <main+0x30>
		    printf(2, "touch: cannot touch %s\n", argv[i]);
  5c:	50                   	push   %eax
  5d:	ff 33                	pushl  (%ebx)
  5f:	68 78 07 00 00       	push   $0x778
  64:	6a 02                	push   $0x2
  66:	e8 b5 03 00 00       	call   420 <printf>
		   	exit();
  6b:	e8 62 02 00 00       	call   2d2 <exit>
	}
 ...
 389:	85 d2                	test   %edx,%edx
{
 ...
 3b7:	f7 f1                	div    %ecx
 3b9:	0f b6 92 98 07 00 00 	movzbl 0x798(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb 90 07 00 00       	mov    $0x790,%ebx
        while(*s != 0){
 ...
 5f1:	a1 48 0a 00 00       	mov    0xa48,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 48 0a 00 00       	mov    %eax,0xa48
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
 ...
 646:	72 ce                	jb     616 <free+0x26>
{
 ...
 667:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 66a:	a3 48 0a 00 00       	mov    %eax,0xa48
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 48 0a 00 00    	mov    0xa48,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 48 0a 00 00    	cmp    %eax,0xa48
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 48 0a 00 00    	mov    0xa48,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 48 0a 00 00    	mov    %edx,0xa48
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 48 0a 00 00 4c 	movl   $0xa4c,0xa48
 747:	0a 00 00 
 74a:	c7 05 4c 0a 00 00 4c 	movl   $0xa4c,0xa4c
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 4c 0a 00 00       	mov    $0xa4c,%eax
 759:	c7 05 50 0a 00 00 00 	movl   $0x0,0xa50
 760:	00 00 00 
