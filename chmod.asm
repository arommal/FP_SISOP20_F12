...
int main(int argc, char *argv[]){
  ...
  15:	7e 5b                	jle    72 <main+0x72>
    ...
    mode_t mode = 0;
    char* p = argv[1];
  17:	8b 53 04             	mov    0x4(%ebx),%edx
    mode_t mode = 0;
  1a:	31 c9                	xor    %ecx,%ecx
    while (*p)
  1c:	0f be 02             	movsbl (%edx),%eax
  1f:	84 c0                	test   %al,%al
  ...
  28:	83 c2 01             	add    $0x1,%edx
        mode += *p - '0';
  2b:	8d 4c c8 d0          	lea    -0x30(%eax,%ecx,8),%ecx
    while (*p)
  2f:	0f be 02             	movsbl (%edx),%eax
  32:	84 c0                	test   %al,%al
  34:	75 f2                	jne    28 <main+0x28>
    }
  ...
  3d:	e8 40 03 00 00       	call   382 <chmod>
  42:	83 c4 10             	add    $0x10,%esp
  45:	85 c0                	test   %eax,%eax
  47:	78 16                	js     5f <main+0x5f>
  ...
  5f:	52                   	push   %edx
  60:	52                   	push   %edx
  61:	68 a2 07 00 00       	push   $0x7a2
  66:	6a 02                	push   $0x2
  68:	e8 c3 03 00 00       	call   430 <printf>
  6d:	83 c4 10             	add    $0x10,%esp
  70:	eb e8                	jmp    5a <main+0x5a>
        printf(2, "chmod: invalid arguments\n");
  72:	51                   	push   %ecx
  73:	51                   	push   %ecx
  74:	68 88 07 00 00       	push   $0x788
  79:	6a 02                	push   $0x2
  7b:	e8 b0 03 00 00       	call   430 <printf>
        exit();
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e4:	e9 8f fe ff ff       	jmp    478 <printf+0x48>
          s = "(null)";
 5e9:	bb c1 07 00 00       	mov    $0x7c1,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 601:	a1 70 0a 00 00       	mov    0xa70,%eax
{
 ...
 63d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 63f:	a3 70 0a 00 00       	mov    %eax,0xa70
}
 644:	5b                   	pop    %ebx
 645:	5e                   	pop    %esi
 646:	5f                   	pop    %edi
 ...
 656:	72 ce                	jb     626 <free+0x26>
{
 ...
 677:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 67a:	a3 70 0a 00 00       	mov    %eax,0xa70
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 70 0a 00 00    	mov    0xa70,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6df:	73 47                	jae    728 <malloc+0x98>
    ...
    if(p == freep)
 6e1:	39 05 70 0a 00 00    	cmp    %eax,0xa70
 ...
 706:	e8 f5 fe ff ff       	call   600 <free>
  return freep;
 70b:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 734:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 737:	89 15 70 0a 00 00    	mov    %edx,0xa70
}
 ...
 757:	0a 00 00 
 75a:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 761:	0a 00 00 
    base.s.size = 0;
 764:	b8 74 0a 00 00       	mov    $0xa74,%eax
 769:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 770:	00 00 00 
