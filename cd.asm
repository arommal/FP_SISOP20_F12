...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 08 03 00 00       	call   342 <chdir>
  ...
  5a:	e8 c1 03 00 00       	call   420 <printf>
      exit();
  5f:	e8 6e 02 00 00       	call   2d2 <exit>
    printf(2, "cd: invalid arguments\n");
  64:	52                   	push   %edx
  65:	52                   	push   %edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 5d4:	e9 8f fe ff ff       	jmp    468 <printf+0x48>
          s = "(null)";
 5d9:	bb a3 07 00 00       	mov    $0x7a3,%ebx
        while(*s != 0){
 ...
 5f1:	a1 60 0a 00 00       	mov    0xa60,%eax
{
 ...
 62d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 62f:	a3 60 0a 00 00       	mov    %eax,0xa60
}
 634:	5b                   	pop    %ebx
 635:	5e                   	pop    %esi
 636:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 689:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 68c:	8b 15 60 0a 00 00    	mov    0xa60,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6cf:	73 47                	jae    718 <malloc+0x98>
    ...
    if(p == freep)
 6d1:	39 05 60 0a 00 00    	cmp    %eax,0xa60
 ...
 6f6:	e8 f5 fe ff ff       	call   5f0 <free>
  return freep;
 6fb:	8b 15 60 0a 00 00    	mov    0xa60,%edx
 ...
 724:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 727:	89 15 60 0a 00 00    	mov    %edx,0xa60
}
 ...
 739:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    base.s.ptr = freep = prevp = &base;
 740:	c7 05 60 0a 00 00 64 	movl   $0xa64,0xa60
 747:	0a 00 00 
 74a:	c7 05 64 0a 00 00 64 	movl   $0xa64,0xa64
 751:	0a 00 00 
    base.s.size = 0;
 754:	b8 64 0a 00 00       	mov    $0xa64,%eax
 759:	c7 05 68 0a 00 00 00 	movl   $0x0,0xa68
 760:	00 00 00 
